...
public class EqualsAndHashcodeTest {
    /**
     * If this is true also classes without a {@code equals} or {@code hashCode} implementation will
     * be tested
     */
    ...
    public static void hashTest(Object original, Object proxy, Object[] unique) {
        ...
        assertEquals(
                original.hashCode(),
                proxy.hashCode(),
                "Hash code of Original Object (" + original + ") and proxy counterpart (" + proxy +
                        ") should be the same"
        );
    ...
    Stream<DynamicNode> testReactiveProxy() {
        ...
        RProxy.WithoutHashEquals withOutHash = creator.create(new RProxy.WithoutHashEquals())
                                                      .getObject();
        RProxy.WithoutHashEquals withOutHash2 = creator.create(new RProxy.WithoutHashEquals())
                                                       .getObject();
