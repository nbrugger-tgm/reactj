...
- [JavaDoc](https://niton.jfrog.io/artifactory/java-libs/com/niton/reactj/4.0.0b9/reactj-4.0.0b9-javadoc.jar!/index.html)
...
```groovy
implementation 'com.niton.reactj:core:4.0.0b9'
implementation 'com.niton.reactj:lists:4.0.0b9'
```

*framework*

```groovy
implementation 'com.niton.reactj:swing:4.0.0b9'
```
