 ...
 * <p>
 * This is useful if there is an implementation you want to use, but you are already extending from
 * a class.
 * Then you can create an instance of your implementation ({@link ReactiveWrapper} for example) and
 * return it from
