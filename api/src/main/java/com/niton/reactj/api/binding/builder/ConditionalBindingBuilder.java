...
import com.niton.reactj.api.binding.builder.exposed.ExposedConditionalBindingBuilder;
 ...
 */
public interface ConditionalBindingBuilder<T, R, O extends CallBuilder>
		extends ExposedConditionalBindingBuilder<T, R, O> {
	/**
